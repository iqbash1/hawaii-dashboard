...
const DASHBOARD_DATA = {
  ...
  "real_per_capita_income": {
    ...
    "howToRead": "Hawai\u02BBi runs below the other-state average throughout. The gap has widened steadily since 2008.",
  ...
  "renter_cost_burden_pct": {
    ...
    "howToRead": "Both lines should fall. Hawai\u02BBi has ranked last or near-last for two decades, and the gap with the national average has widened.",
  ...
  "unsheltered_homeless_rate": {
    ...
    "howToRead": "Hawai\u02BBi runs far above the other-state average throughout. Even small declines represent hundreds of lives improved.",
