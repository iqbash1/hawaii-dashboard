...
const DASHBOARD_DATA = {
  "violent_crime_rate": {
    ...
    "howToRead": "The other-state average tracks the classic crime wave, peaking in the early 1990s then falling. Hawaiʻi stays below the average throughout but peaked later, around 2016, before declining. The 1971 spike reflects incomplete early UCR reporting, not an actual increase.",
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #5 to #21 since 1985, mostly in the #8 to #14 range, running 35 to 40 percent below the other-state average. Geographic isolation limits weapons trafficking, and multigenerational community networks where people look out for each other.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Maine",
  ...
  "property_crime_rate": {
    ...
    "nextUpdate": "Oct",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #37 to #45 for most of the past 40 years and sits at #36 in 2024. Tourist density concentrates theft targets, and methamphetamine-related theft-driven crime drives a disproportionate share of incidents.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "New York",
  ...
  "suicide_rate": {
    ...
    "howToRead": "Hawaiʻi has stayed below the other-state average for most of the past 25 years. The gap is volatile from year to year due to small population, so focus on the multi-year trend rather than single-year movements.",
  ...
  "ba_or_higher_pct": {
    ...
    "howToRead": "Both lines rise steadily over two decades. Hawaiʻi tracks slightly above the other-state average throughout.",
  ...
  "naep_reading_8": {
    ...
    "nextUpdate": "May",
    "rankHistoryNarrative": {
      "summary": "Hawaii ranked below the other-state average for two decades, with a 10-to-12-point gap from 2003 through the early 2010s. The gap closed sharply since 2013 as Hawaii improved and the other-state average declined. By 2024 Hawaii reached near-parity for the first time on record.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Mississippi",
  ...
  "unemployment_rate": {
    ...
    "howToRead": "Hawaiʻi runs below the other-state average in normal years. The COVID spike and snapback dominate the recent chart.",
  ...
  "home_price_to_income": {
    ...
    "howToRead": "Hawaiʻi stays above the other-state average throughout, with no sustained narrowing of the gap.",
  ...
  "road_poor_pct": {
    ...
    "howToRead": "Hawaiʻi stays far above the other-state average at both thresholds. The default view shows roads rated poor only; the poor-and-mediocre view adds acceptable/mediocre roads, roughly tripling the share. The gap has narrowed since 2013 but remains large.",
  ...
  "broadband_subscription_pct": {
    ...
    "howToRead": "Both lines rise steadily toward universal coverage. Hawaiʻi has tracked above the other-state average, though the gap has narrowed in recent years.",
  ...
  "renewables_share_gen": {
    ...
    "howToRead": "Hawaiʻi started below the other-state average. The gap widened through the 2010s as mainland states rapidly added wind, then began narrowing as Hawaiʻi's solar and battery installations accelerated.",
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked below the other-state average for most of its history. The gap widened through the 2010s as mainland states rapidly added wind. Hawaii has improved in absolute terms but fallen further behind in relative terms.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Iowa",
  ...
  "estabs_entry_rate": {
    ...
    "howToRead": "Hawaiʻi has run below the other-state average since the mid-1990s, with no sustained closing of the gap.",
  ...
  "net_employer_formation": {
    ...
    "howToRead": "A positive number means more employer businesses opened than closed that year. Hawaiʻi sits below the other-state average in most years and dips below zero in downturns.",
