...
// Hawaii values and medianSeries (50-state mathematical median, includes
...
const DASHBOARD_DATA = {
  "violent_crime_rate": {
    ...
    "howToRead": "The other-state median tracks the classic crime wave, peaking in the early 1990s then falling. Hawaiʻi has been better than the median throughout but peaked later, around 2016, before declining. The 1971 spike reflects incomplete early UCR reporting, not an actual increase.",
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #5 to #21 since 1985, mostly in the #8 to #14 range, running 35 to 40 percent better than the other-state median. Geographic isolation limits weapons trafficking, and multigenerational community networks where people look out for each other.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Maine",
          "text": "Like Hawaiʻi, Maine is geographically isolated with low population density and strong community-based social cohesion. Maine has ranked #1 or #2 in violent crime rate for most of the past three decades and has maintained that position through significant economic and demographic shifts. Maine's rate has stayed below 130 per 100K for most of the past decade, roughly a third of the other-state median. The core factors are consistent: low population density that limits anonymity, very low gang activity, and community-centered law enforcement that emphasizes relationship-based approaches over reactive response.",
          "source": {
  ...
  "pcp_per_100k": {
    ...
    "howToRead": "Hawaiʻi's line runs flat and better than the other-state median for the past decade. Military doctors are excluded.",
    ...
    "nextUpdate": "Jun",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked in the top 10 every year on record, about 14 percent better than the other-state median. Neighbor island communities hold federal Health Professional Shortage Area designations despite the strong statewide number.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Vermont",
  ...
  "uninsured_rate": {
    ...
    "howToRead": "Both lines have fallen since 2012. Hawaiʻi has been consistently better than the other-state median throughout, and the gap persists.",
  ...
  "suicide_rate": {
    ...
    "howToRead": "Hawaiʻi has stayed better than the other-state median for most of the past 25 years. The gap is volatile from year to year due to small population, so focus on the multi-year trend rather than single-year movements.",
  ...
  "acgr": {
    ...
    "whyItMatters": "Hawaiʻi runs the only statewide school district in the nation, making the State directly accountable. The graduation rate reached 86% in 2022, roughly matching the other-state median of 85.9%.",
    "scale": {
      "denominator": 13000,
    ...
    "nextUpdate": "Aug",
    "rankHistoryNarrative": {
      "summary": "Hawaii ranked #29 in 2022, roughly matching the other-state median. It improved 6 points from 2011 to 2022, but most states improved faster. As the only statewide school district, the graduation rate is directly a function of state policy.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Virginia",
  ...
  "ba_or_higher_pct": {
    ...
    "howToRead": "Both lines rise steadily over two decades. Hawaiʻi has tracked slightly better than the other-state median throughout.",
    ...
    "nextUpdate": "Sep",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked near the middle since 2005, tracking 1 to 2 points better than the other-state median. The rank holds steady because most states improved at similar rates. In-migration of college-educated military and federal employees inflates the attainment rate.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Colorado",
  ...
  "unemployment_rate": {
    ...
    "howToRead": "Hawaiʻi has been better than the other-state median in normal years. The COVID spike and snapback dominate the recent chart.",
  ...
  "real_per_capita_income": {
    ...
    "howToRead": "All values are in constant 2017 dollars, so a flat line means no real income growth. Hawaiʻi has been worse than the other-state median throughout. Real purchasing power barely grew from 2008 to 2018, then spiked during COVID-era federal transfers before pulling back.",
  ...
  "renter_cost_burden_pct": {
    ...
    "howToRead": "Both lines should fall. At the 30%+ threshold (the default view), Hawaiʻi has ranked last or near-last for two decades and the gap with the other-state median has widened. The 50%+ view isolates the most severely burdened renters; the pattern is similar but values are roughly half.",
  ...
  "home_price_to_income": {
    ...
    "howToRead": "Hawaiʻi has been consistently worse than the other-state median throughout, with no sustained narrowing of the gap.",
  ...
  "road_poor_pct": {
    ...
    "howToRead": "Hawaiʻi is far worse than the other-state median at both thresholds. The default view shows roads rated poor only; the poor-and-mediocre view adds acceptable/mediocre roads, roughly tripling the share. The gap has narrowed since 2013 but remains large.",
  ...
  "broadband_subscription_pct": {
    ...
    "howToRead": "Both lines rise steadily toward universal coverage. Hawaiʻi has been better than the other-state median, though the gap has narrowed in recent years.",
  ...
  "renewables_share_gen": {
    ...
    "howToRead": "Hawaiʻi has run slightly ahead of the other-state median for most of the record, reflecting how few states generate a large share from renewables. The gap widened through the 2010s and 2020s as Hawaiʻi's solar and battery installations accelerated. A handful of hydro- and wind-heavy states still sit far above Hawaiʻi, which is why Hawaiʻi ranks near the middle (#22) despite being above the typical state.",
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has generated a larger share of its electricity from renewables than the typical state throughout the two decades on record. Rank #22 reflects a handful of hydro- and wind-heavy states (Washington, Iowa, Oregon, South Dakota) that pull well ahead in absolute share. Hawaii has kept improving but has not closed the gap with those leaders.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Iowa",
  ...
  "rainy_day_fund_pct": {
    ...
    "howToRead": "Hawaiʻi held near zero through the early 2010s while the other-state median climbed steadily. Starting around 2017, Hawaiʻi began building reserves. COVID drained the fund to 0.7% in 2020, followed by a steep climb, crossing the 10% recommended floor for the first time.",
  ...
  "voter_participation_rate": {
    ...
    "howToRead": "The zigzag pattern reflects presidential years (higher turnout) vs. midterm elections (lower). Hawaiʻi has been worse than the other-state median for over 40 years, and the gap has widened: 8 points in 1980, 15 points in 2024.",
  ...
  "estabs_entry_rate": {
    ...
    "howToRead": "Hawaiʻi has been worse than the other-state median since the mid-1990s, with no sustained closing of the gap.",
  ...
  "net_employer_formation": {
    ...
    "howToRead": "A positive number means more employer businesses opened than closed that year. Hawaiʻi has been worse than the other-state median in most years and dips below zero in downturns.",
