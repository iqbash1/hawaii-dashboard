...
const DASHBOARD_DATA = {
  ...
  "property_crime_rate": {
    ...
    "nextUpdate": "Oct",
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi has ranked #37 to #45 for most of the past 40 years and now ranks #36 in 2024. Tourist density concentrates theft targets, and methamphetamine-related theft-driven crime drives a disproportionate share of incidents.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "New York",
  ...
  "labor_force_participation": {
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi ranked #5 in 1976 and has fallen to #39 in 2024. The decline tracks the shift from plantation agriculture to tourism and hospitality, with part-time schedules and lower wages replacing full-time cross-skill employment.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Minnesota",
