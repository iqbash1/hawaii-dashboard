...
const DASHBOARD_DATA = {
  "violent_crime_rate": {
    ...
    "howToRead": "The other-state average tracks the classic crime wave, peaking in the early 1990s then falling. Hawaiʻi has been better than the average throughout but peaked later, around 2016, before declining. The 1971 spike reflects incomplete early UCR reporting, not an actual increase.",
  ...
  "property_crime_rate": {
    ...
    "nextUpdate": "Oct",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #37 to #45 for most of the past 40 years and now ranks #36 in 2024. Tourist density concentrates theft targets, and methamphetamine-related theft-driven crime drives a disproportionate share of incidents.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "New York",
  ...
  "pcp_per_100k": {
    ...
    "howToRead": "Hawaiʻi's line runs flat and better than the other-state average for the past decade. Military doctors are excluded.",
    ...
    "nextUpdate": "Jun",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked in the top 10 every year on record, about 14 percent better than the other-state average. Neighbor island communities hold federal Health Professional Shortage Area designations despite the strong statewide number.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Vermont",
  ...
  "uninsured_rate": {
    ...
    "howToRead": "Both lines have fallen since 2012. Hawaiʻi has been consistently better than the other-state average throughout, and the gap persists.",
  ...
  "acgr": {
    ...
    "whyItMatters": "Hawaiʻi runs the only statewide school district in the nation, making the State directly accountable. The graduation rate reached 86% in 2022, roughly matching the other-state average of 85.9%. Hawaiʻi has about 13,000 public-school seniors in each cohort, so each percentage point on this rate represents roughly 130 students graduating or not graduating on time.",
    "scale": {
      "denominator": 13000,
    ...
    "nextUpdate": "Aug",
    "rankHistoryNarrative": {
      "summary": "Hawaii ranked #29 in 2022, roughly matching the other-state average. It improved 6 points from 2011 to 2022, but most states improved faster. As the only statewide school district, the graduation rate is directly a function of state policy.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Virginia",
  ...
  "ba_or_higher_pct": {
    ...
    "howToRead": "Both lines rise steadily over two decades. Hawaiʻi has tracked slightly better than the other-state average throughout.",
    ...
    "countyNarrative": "Honolulu County has the highest bachelor's degree attainment of the four counties, supported by the University of Hawaiʻi at Manoa, federal government and military employment, and a more diverse professional services sector. Maui County is near the state average, with higher-income resort and management occupations partly offset by a large accommodation and food service workforce. Kauai County follows a similar pattern to Maui at a smaller scale. The three neighbor island counties cluster near 30-32%, with Kauai at the lowest in recent data, while Honolulu leads at roughly 37%, reflecting its rural economy anchored in agriculture, small-scale tourism, and a higher share of retirees and lower-wage workers relative to the other counties.",
    "useConsolidated": true,
    "hawaii": {
      "2005": 0.2795,
      "2006": 0.2967,
    ...
    "nextUpdate": "Sep",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked near the middle since 2005, tracking 1 to 2 points better than the other-state average. The rank holds steady because most states improved at similar rates. In-migration of college-educated military and federal employees inflates the attainment rate.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Colorado",
  ...
  "unemployment_rate": {
    ...
    "howToRead": "Hawaiʻi has been better than the other-state average in normal years. The COVID spike and snapback dominate the recent chart.",
    ...
    "updateCadence": "Annual",
    "nextUpdate": "Mar",
    "latestMonthly": {"value":2.2,"period":"Jan 2026","asOf":"2026-04-13"},
    "rankHistoryNarrative": {
  ...
  "labor_force_participation": {
    ...
    "updateCadence": "Annual",
    "nextUpdate": "Mar",
    "latestMonthly": {"value":60.7,"period":"Jan 2026","asOf":"2026-04-13"},
    "rankHistoryNarrative": {
  ...
  "real_per_capita_income": {
    ...
    "howToRead": "All values are in constant 2017 dollars, so a flat line means no real income growth. Hawaiʻi has been worse than the other-state average throughout. Real purchasing power barely grew from 2008 to 2018, then spiked during COVID-era federal transfers before pulling back.",
  ...
  "renter_cost_burden_pct": {
    ...
    "howToRead": "Both lines should fall. At the 30%+ threshold (the default view), Hawaiʻi has ranked last or near-last for two decades and the gap with the other-state average has widened. The 50%+ view isolates the most severely burdened renters; the pattern is similar but values are roughly half.",
  ...
  "home_price_to_income": {
    ...
    "howToRead": "Hawaiʻi has been consistently worse than the other-state average throughout, with no sustained narrowing of the gap.",
  ...
  "road_poor_pct": {
    ...
    "howToRead": "Hawaiʻi is far worse than the other-state average at both thresholds. The default view shows roads rated poor only; the poor-and-mediocre view adds acceptable/mediocre roads, roughly tripling the share. The gap has narrowed since 2013 but remains large.",
    ...
    "nextUpdate": "Nov",
    "rankHistoryNarrative": {
      "summary": "At the poor-only threshold, Hawaiʻi has ranked #45 to #47 every year since 2007, with no sustained improvement. The poor-and-mediocre view (both combined) shows about 60% of Hawaiʻi's rated miles are below good condition, roughly double the other-state average. Salt air, heavy rainfall, and volcanic soil accelerate deterioration, and preventive maintenance is consistently the first item cut when budgets tighten.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Virginia",
  ...
  "broadband_subscription_pct": {
    ...
    "howToRead": "Both lines rise steadily toward universal coverage. Hawaiʻi has been better than the other-state average, though the gap has narrowed in recent years.",
  ...
  "renewables_share_gen": {
    ...
    "howToRead": "Hawaiʻi started worse than the other-state average. The gap widened through the 2010s as mainland states rapidly added wind, then began narrowing as Hawaiʻi's solar and battery installations accelerated.",
    ...
    "updateCadence": "Annual",
    "nextUpdate": "Mar",
    "latestMonthly": {"value":11.8,"period":"Jan 2026","asOf":"2026-04-13"},
    "rankHistoryNarrative": {
      "summary": "Hawaii has been worse than the other-state average for most of its history. The gap widened through the 2010s as mainland states rapidly added wind. Hawaii has improved in absolute terms but fallen further behind in relative terms.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Iowa",
  ...
  "rainy_day_fund_pct": {
    ...
    "howToRead": "Hawaiʻi held near zero through the early 2010s while the other-state average climbed steadily. Starting around 2017, Hawaiʻi began building reserves. COVID drained the fund to 0.7% in 2020, followed by a steep climb, crossing the 10% recommended floor for the first time.",
  ...
  "estabs_entry_rate": {
    ...
    "howToRead": "Hawaiʻi has been worse than the other-state average since the mid-1990s, with no sustained closing of the gap.",
  ...
  "net_employer_formation": {
    ...
    "howToRead": "A positive number means more employer businesses opened than closed that year. Hawaiʻi has been worse than the other-state average in most years and dips below zero in downturns.",
