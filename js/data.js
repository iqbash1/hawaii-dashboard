...
const DASHBOARD_DATA = {
  "violent_crime_rate": {
    ...
    "howToRead": "The median tracks the classic crime wave, peaking in the early 1990s then falling. Hawaiʻi has been better than the median throughout but peaked later, around 2016, before declining. The 1971 spike reflects incomplete early UCR reporting, not an actual increase.",
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #5 to #21 since 1985, mostly in the #8 to #14 range, running 35 to 40 percent better than the median. Geographic isolation limits weapons trafficking, and multigenerational community networks where people look out for each other.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Maine",
  ...
  "pcp_per_100k": {
    ...
    "nextUpdate": "Jun",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked in the top 10 every year on record, about 14 percent better than the median. Neighbor island communities hold federal Health Professional Shortage Area designations despite the strong statewide number.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Vermont",
  ...
  "acgr": {
    ...
    "nextUpdate": "Aug",
    "rankHistoryNarrative": {
      "summary": "Hawaii ranked #29 in 2022, roughly matching the median. It improved 6 points from 2011 to 2022, but most states improved faster. As the only statewide school district, the graduation rate is directly a function of state policy.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Virginia",
  ...
  "ba_or_higher_pct": {
    ...
    "nextUpdate": "Sep",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked near the middle since 2005, tracking 1 to 2 points better than the median. The rank holds steady because most states improved at similar rates. In-migration of college-educated military and federal employees inflates the attainment rate.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Colorado",
  ...
  "naep_reading_8": {
    ...
    "nextUpdate": "May",
    "rankHistoryNarrative": {
      "summary": "Hawaii was worse than the median for two decades, with a 10-to-12-point gap from 2003 through the early 2010s. The gap closed sharply since 2013 as Hawaii improved and the median declined. By 2024 Hawaii reached near-parity for the first time on record.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Mississippi",
