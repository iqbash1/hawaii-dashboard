...
const DASHBOARD_DATA = {
  ...
  "uninsured_rate": {
    ...
    "updateCadence": "Annual",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #1 or #2 in health coverage every year on record. The rate fell from 7.9 percent in 2010 to 2.8 percent in 2023 following ACA expansion, then ticked to 3.5 percent in 2024 as pandemic-era continuous Medicaid enrollment ended.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Massachusetts",
