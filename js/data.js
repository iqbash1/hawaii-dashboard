...
const DASHBOARD_DATA = {
  ...
  "broadband_subscription_pct": {
    ...
    "updateCadence": "Annual",
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked in the top quarter since 2016, consistently 1 to 2 points above the other-state average. The lead reflects high household income and urban density on Oahu. Remaining unsubscribed households are concentrated in rural neighbor island areas where affordability, not infrastructure, is the constraint.",
      "mode": "protect",
      "benchmarks": [
        {
          "state": "Utah",
  ...
  "voter_participation_rate": {
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked near or at the bottom for four decades, holding #50 in every presidential election since 2004. All-mail voting (2020) produced no lasting increase. The gap with the national average has widened from 8 points in 1980 to 15 points in 2024, suggesting barriers are structural: one-party dominance, military residents voting elsewhere, and limited English-language political engagement.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Colorado",
