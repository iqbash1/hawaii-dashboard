...
const DASHBOARD_DATA = {
    ...
    "rankHistoryNarrative": {
      ...
      "caution": {
        ...
        "source": {
          ...
          "url": "https://www.cdc.gov/nchs/state-stats/deaths/suicide.html"
        }
      }
    }
  },
  "acgr": {
    ...
    "dataLag": 4,
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi ranked #29 in 2022, roughly matching the median. It improved 6 points from 2011 to 2022, but about half the states improved faster. As the only statewide school district, the graduation rate is directly a function of state policy.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Virginia",
  ...
  "naep_math_8": {
    ...
    "nextUpdate": "Biennial",
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi improved from #47 in 2003 to #30 in 2024, the largest rank gain of any metric on this dashboard. The 2022-2024 rank gain came without a score gain: Hawaiʻi held steady while several states that had scored better slipped to worse scores. Teacher turnover driven by cost of living and cross-island variation in school quality remain persistent challenges.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Massachusetts",
  ...
  "unemployment_rate": {
    ...
    "nextUpdate": "Mar",
    "latestMonthly": {"value":2.7,"period":"Jul 2026","asOf":"2026-09-12"},
    "rankHistoryNarrative": {
  ...
  "labor_force_participation": {
    ...
    "nextUpdate": "Mar",
    "latestMonthly": {"value":61,"period":"Jul 2026","asOf":"2026-09-12"},
    "rankHistoryNarrative": {
  ...
  "renter_cost_burden_pct": {
    ...
    "countyNarrative": "At the 30%+ threshold, cost burden is elevated in all four counties; in 2024 only Kauaʻi (48%) edged better than the 49% median of states. Maui rose from 47% in 2013 to 55% in 2024, likely tied to the conversion of long-term rentals to vacation units, while Honolulu (55% in 2024) stayed roughly flat. Hawaiʻi County's earlier improvement has reversed: after falling from 60% in 2013 to 49% in 2021, it was back at 60% in 2024, the worst of the four counties. The 50%+ severe level shows the same reversal more sharply: Hawaiʻi County's severe share climbed from 21.5% in 2021 to 36.1% in 2024, a series high and the worst of the four for two straight years, while Kauaʻi's severe share (18%) is notably lower than its overall 30%+ burden would suggest.",
    "externalCitations": [
      {
  ...
  "residential_price_cpkwh": {
    ...
    "nextUpdate": "Mar",
    "latestMonthly": {"value":52.72,"period":"Jun 2026","asOf":"2026-09-12"},
    "rankHistoryNarrative": {
  ...
  "renewables_share_gen": {
    ...
    "countyNarrative": "Renewable progress varies sharply by island because each runs its own isolated grid. Kauaʻi (KIUC) leads the state's utilities, with solar-plus-battery and hydropower covering <a href=\"https://kiuc.coop/renewable-portfolio\">52.8 percent of its electricity in 2025</a>, and it targets 100 percent by 2033, well ahead of the state's 2045 deadline. Hawaiʻi Island benefits from the Puna Geothermal Venture providing renewable baseload, supplemented by growing solar. Maui County has expanded solar and wind but faces land-use constraints. Oʻahu, which accounts for the large majority of statewide generation demand, has the lowest renewable share and the longest path to the 100% Clean Energy goal; the state's overall figure rises or falls primarily on Oʻahu's pace.",
    "useConsolidated": true,
    "hawaii": {
      "2001": 0.0562,
      "2002": 0.04,
    ...
    "nextUpdate": "Mar",
    "latestMonthly": {"value":24.7,"period":"Jun 2026","asOf":"2026-09-12"},
    "rankHistoryNarrative": {
  ...
  "voter_participation_rate": {
    ...
    "policyLevers": "<ul class='cn-focus-list'><li><strong>Electoral competition</strong> · Research finds each additional competitive party or candidate increases participation by 3.5 to 6 percentage points <a href=\"https://link.springer.com/article/10.1007/s11109-022-09810-5\" target=\"_blank\" rel=\"noopener\" class=\"cn-cite\">↗</a>; reforms such as open primaries or ranked-choice voting could raise effective competition <a href=\"https://apnews.com/article/b0db5c6a5c3f5e1745c9b9cc646126f5\" target=\"_blank\" rel=\"noopener\" class=\"cn-cite\">↗</a>.</li><li><strong>Access infrastructure</strong> · Colorado's all-mail voting increased participation roughly 8 percentage points, with the largest gains among low-propensity voters <a href=\"https://pmc.ncbi.nlm.nih.gov/articles/PMC9756790/\" target=\"_blank\" rel=\"noopener\" class=\"cn-cite\">↗</a>; Hawaiʻi adopted all-mail voting in 2020 but ranks #50, suggesting logistical reform alone does not overcome low motivation to vote when races are uncompetitive.</li><li><strong>Candidate entry and civic engagement</strong> · Matching-fund public financing and lower contribution thresholds in other jurisdictions have increased candidate entry <a href=\"https://uhero.hawaii.edu/wp-content/uploads/2023/02/Public-Campaign-Financing.pdf\" target=\"_blank\" rel=\"noopener\" class=\"cn-cite\">↗</a>; MIT Election Lab notes automatic voter registration increases registration but does not reliably translate to higher participation without competitive elections <a href=\"https://electionlab.mit.edu/research/automatic-voter-registration\" target=\"_blank\" rel=\"noopener\" class=\"cn-cite\">↗</a>.</li></ul>",
    "nextUpdate": "Nov",
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi has ranked near or at the bottom for four decades, holding #50 in every presidential election since 2004 except 2020, when it reached #47. All-mail voting, introduced in 2020, did lift turnout: Hawaiʻi gained 7.1 points between 2016 and 2024, more than twice the gain in most states. The rank barely moved because other states reformed over the same stretch.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Colorado",
          "text": "Like Hawaiʻi, Colorado adopted all-mail voting, but paired it with automatic voter registration and competitive elections across the ballot. Colorado enacted universal vote-by-mail in 2013 (HB 1303) paired with same-day voter registration at voting service centers and automatic voter registration through the DMV. Colorado went from worse than average participation in the early 2000s to consistently ranking in the top 10 by 2016. Approximately 15 to 20 percent of Colorado voters in recent elections registered on election day or in the final week, a direct result of same-day registration availability.",
          "source": {
      ...
      "explore": [
        "Colorado paired all-mail voting with automatic registration and competitive elections; Oregon's all-mail gains faded without those reinforcing factors. In Hawaiʻi, roughly 27 percent of residents speak a language other than English at home, a barrier some high-participation states address through multilingual voter guides. Consistent one-party margins in statewide races also reduce the financial incentive for either party to invest in aggressive voter mobilization."
      ],
      "caution": {
        "state": "Oregon",
        "text": "Like Hawaiʻi, Oregon adopted all-mail voting but found that logistical reform alone did not sustain participation gains over time. Oregon pioneered all-mail voting in 2000 and maintained better-than-average participation for over a decade. Oregon's ranking has since declined as other states adopted mail voting without Oregon maintaining a comparable lead. Vote-by-mail removes logistical barriers for motivated voters but does not independently create the civic engagement that drives high participation.",
        "source": {
  ...
  "net_domestic_migration_rate": {
    ...
    "countyNarrative": "The domestic migration loss has long been concentrated on Oʻahu: Honolulu County has run a net domestic outflow in every reported year of the county series, reflecting the combination of high housing costs and limited industry diversity in the state's most densely settled county, though its 2024 outflow (roughly 60 residents per 10,000) was the mildest since 2013. Hawaiʻi County (Big Island) is the only county with net domestic in-migration every year since 2021, as lower home prices attract residents priced out of Honolulu, but that inflow has slowed four years running. Maui County's migration dynamics shifted significantly after the August 2023 wildfires: its 2024 outflow was Maui's worst year in the series and the steepest of any county that year, with fire-related displacement adding to underlying cost pressures. Kauaʻi County's small population makes annual migration figures volatile, but high costs relative to local wages create similar outmigration pressure.",
    "externalCitations": [
      {
        "id": "housing_wage_2023",
        "label": "$41.83",
  ...
  "labor_productivity": {
    ...
    "nextUpdate": "Jun",
    "rankHistoryNarrative": {
      "summary": "Hawaiʻi's rank slid from #7 in 2018 to #43 in 2023, then climbed back to #37 by 2025. The volatility reflects tourism's outsized role in GDP: visitor spending moves output faster than hours worked can adjust.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Massachusetts",
  ...
  "gini_index": {
    ...
    "potentialDrivers": "Hawaiʻi's income gap is narrower than most states, and the underlying income shares show why: the top is thin, not the bottom raised. Hawaiʻi's highest earners hold one of the smallest income shares in the country, because the economy leans on tourism, government, and services rather than the finance and technology sectors that concentrate very high incomes in states like New York and Connecticut, per <a href=\"https://dbedt.hawaii.gov/economic/\" target=\"_blank\" rel=\"noopener\">DBEDT</a> and <a href=\"https://data.census.gov/table?q=B19082\" target=\"_blank\" rel=\"noopener\">Census income-share data</a>. The bottom fifth's share, by contrast, sits close to the national middle. Hawaiʻi does have one of the highest union membership rates in the country, per <a href=\"https://www.bls.gov/news.release/union2.htm\" target=\"_blank\" rel=\"noopener\">BLS</a>, and a wage floor among the higher state minimums, set to reach $18 an hour by 2028, per the <a href=\"https://labor.hawaii.gov/wsd/minimum-wage/\" target=\"_blank\" rel=\"noopener\">Hawaiʻi Department of Labor</a>; these support pay at the bottom, but the narrow gap traces mainly to the thin top rather than an unusually high floor. The caution is that a narrow gap is not the same as broad comfort: Hawaiʻi's high cost of living means many middle households still feel stretched, so a relatively equal spread can coexist with widespread financial strain.",
    "useConsolidated": true,
    "hawaii": {
      "2006": 43.8,
      "2007": 42.2,
