...
const DASHBOARD_DATA = {
  ...
  "unsheltered_homeless_rate": {
    ...
    "countyNarrative": "Kauai has the highest unsheltered rate by a wide margin (63 per 10K in 2024, more than double any other county), having tripled since 2015. Honolulu carries the largest absolute count due to population size, but its per-capita rate (28.3) is lower than Kauai's. Hawai\u02BBi County's rate has been volatile, peaking at 57 per 10K in 2016 before falling to 25 in 2024. Maui's rate declined to 17 per 10K in 2024, the lowest of the four counties, despite the August 2023 wildfires displacing thousands of residents (most wildfire-displaced residents were counted as sheltered, not unsheltered).",
    "useConsolidated": true,
