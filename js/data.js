...
const DASHBOARD_DATA = {
  "violent_crime_rate": {
    ...
    "insight": "Hawaiʻi's violent crime rate stood at just 22 per 100K in 1960, well below a national average of 162. Both lines rose through the 1960s-1980s as the crime wave built, then fell after 1993. In 2024, Hawaiʻi's rate of 218 per 100K is among the lowest recorded values in the series and 36% below the other-state average of 340.",
    ...
    "potentialDrivers": "Two structural factors appear to help keep Hawaiʻi's rate well below the national average. <a href=\"https://www.census.gov/quickfacts/fact/table/HI/HSD410223\">Census QuickFacts</a> shows Hawaiʻi's 65+ share was 21.5 percent in 2024 versus 18.0 percent nationally, and <a href=\"https://ojjdp.ojp.gov/model-programs-guide/literature-reviews/age-boundaries-of-the-juvenile-justice-system\">DOJ's OJJDP</a> notes that offending typically peaks around ages 18 to 21 and declines sharply through the early 20s, so an older age mix mechanically lowers exposure. Hawaiʻi's <a href=\"https://ag.hawaii.gov/cpja/files/2024/08/Gun-Violence-in-Hawaii-Landscape-Report-5-2024-Email-Version.pdf\">Attorney General gun violence report</a> found firearms were the least used weapon in violent index crimes and that the state has some of the nation's most comprehensive gun laws, suggesting lower gun exposure also contributes. One measurement note: <a href=\"https://www.hawaiitourismauthority.org/media/14038/december-2024-visitor-statistics-pr\">HTA reported</a> an average daily visitor census of 230,438 in 2024, which effectively understates the true at-risk population in the per-100,000 denominator, making the rate look modestly better than it might otherwise.",
  ...
  "uninsured_rate": {
    ...
    "potentialDrivers": "Hawaiʻi's low uninsured rate is most likely driven by the <a href=\"https://labor.hawaii.gov/dcd/files/2023/05/PHC-highlights-rev-2025.03.pdf\">Prepaid Health Care Act</a>, which requires employers to offer coverage to eligible workers generally defined as those at 20 or more hours per week after four consecutive weeks, with employee contributions capped at 1.5 percent of monthly wages. Public coverage provides an important backstop: <a href=\"https://medquest.hawaii.gov/content/dam/formsanddocuments/med-quest/1115-demonstration-post-award-public-forum/Hawaii%201115%20W%20Annual%20CMS%20Monitoring%20Rpt_FFY2024%20FINAL%2001.pdf\">Med-QUEST completed renewals for roughly 475,000 Medicaid members</a> in late 2024 despite Maui wildfire disruptions, and <a href=\"https://www.cms.gov/files/document/health-insurance-exchanges-2025-open-enrollment-report.pdf\">CMS reported</a> 24,606 Hawaiʻi marketplace plan selections for 2025, up 11 percent from the prior year. Gaps remain: the mandate excludes lower-hour workers, and a <a href=\"https://health.hawaii.gov/opppd/files/2024/10/SHIP-Access-to-Health-Services-2024.pdf\">2024 Hawaii DOH access report</a> found that immigrants, migrant workers, Native Hawaiians, and rural residents continue to face coverage barriers that keep the uninsured rate above zero.",
  ...
  "ba_or_higher_pct": {
    ...
    "potentialDrivers": "Population mix and selective migration appear to boost Hawaiʻi's share above what the local economy alone would produce. A <a href=\"https://files.hawaii.gov/dbedt/economic/reports/Detailed-race-characteristics_ACS2021.pdf\">2024 DBEDT report on race characteristics</a> (based on 2021 ACS data) found that Asians made up 56.3 percent of Hawaiʻi's population and that Japanese, Chinese, Korean, Okinawan, and White residents were more likely than the state total to hold bachelor's degrees. <a href=\"https://uhero.hawaii.edu/who-is-moving-in-and-out-understanding-migration-trends-in-hawaii/\">UHERO found in 2025</a> that net migration was positive for White and Asian residents and concentrated in the 25-to-44 age group, which may be nudging the degree share upward by adding credential-holders rather than growing them locally. Against that, <a href=\"https://labor.hawaii.gov/state-releases-forecast-for-jobs-and-industries-through-2032/\">DLIR projected in 2025</a> that food services and accommodation would remain among the fastest-growing industries through 2032, and <a href=\"https://uhero.hawaii.edu/beyond-the-price-of-paradise-is-hawaii-being-left-behind/\">UHERO noted in 2026</a> that Hawaiʻi's heavy tourism dependence and limited high-value service exports likely keep the share above average but out of the top tier.",
  ...
  "naep_reading_8": {
    ...
    "crossInsight": "Hawaiʻi's reading score of 257.3 is within half a point of the other-state average of 256.9, the closest Hawaiʻi has been in two decades of NAEP data. If the current trajectory holds through the next testing cycle, Hawaiʻi will have closed a 20-year gap, a turnaround unmatched in states of comparable size.",
    "potentialDrivers": "Absenteeism is the main documented headwind. A <a href=\"https://nces.ed.gov/nationsreportcard/blog/attendance_and_naep_2022_score_declines.aspx\">2023 NCES analysis</a> found a clear association between rising chronic absenteeism and lower NAEP reading scores, and a <a href=\"https://boe.hawaii.gov/wp-content/uploads/2024/11/2024-11-21_SAC_school-attendance.pdf\">November 2024 Board of Education report</a> found regular attendance had recovered to 75 percent, up from 66 percent in 2021-22, showing the state was still climbing back from pandemic-era missed learning time. On the recovery side, <a href=\"https://hawaiipublicschools.org/about/federal-grants/\">HIDOE received a $60 million federal literacy grant in 2024</a>, and <a href=\"https://hawaiipublicschools.org/2025-hawaii-public-schools-rank-4th-in-math-recovery-2nd-in-reading-recovery-national-report-finds/\">HIDOE reported in 2025</a> that Hawaiʻi ranked second nationally in reading recovery from 2019 to 2024, suggesting that targeted literacy investment helped offset absenteeism losses. The <a href=\"https://nces.ed.gov/nationsreportcard/subject/publications/stt2024/pdf/2024220HI8.pdf\">2024 NCES Hawaiʻi snapshot</a> shows the state's score is statistically tied with the U.S. average, so this metric is better read as a near-average result with positive momentum than as a persistent weakness.",
    "useConsolidated": true,
    "dataNote": "NAEP is administered every 2 years. Hawaiʻi did not participate in some earlier rounds.",
    "hawaii": {
      "2003": 251.28,
  ...
  "unemployment_rate": {
    ...
    "potentialDrivers": "Hawaiʻi's low unemployment reflects both genuine labor demand and constrained labor supply. On the demand side, tourism-driven employment in accommodation, food services, and retail creates consistent year-round job openings across the state. <a href=\"https://www.bls.gov/news.release/laus.nr0.htm\" target=\"_blank\" rel=\"noopener\">BLS reported in January 2026</a> that Hawaiʻi tied with South Dakota for the nation's lowest state unemployment rate at 2.2 percent in December 2025, well below the national rate of 4.4 percent. A broader measure confirms the picture holds: <a href=\"https://www.bls.gov/regions/west/news-release/laborunderutilization_hawaii.htm\" target=\"_blank\" rel=\"noopener\">BLS found in March 2026</a> that Hawaiʻi's U-6 underutilization rate, which adds marginally attached workers and involuntary part-timers to the headline count, was 5.7 percent in 2025 against a U.S. rate of 8.0 percent, so the low headline number is not masking unusual levels of hidden slack. On the supply side, <a href=\"https://uhero.hawaii.edu/wp-content/uploads/2026/02/UHEROForecastForTheStateOfHawaii26Q1.pdf\" target=\"_blank\" rel=\"noopener\">UHERO noted in February 2026</a> that the recent decline partly reflects flattening labor force growth relative to employment and Hawaiʻi's structural labor-market characteristics, even as job openings and payroll data point to softening conditions. <a href=\"https://dbedt.hawaii.gov/blog/26-11/\" target=\"_blank\" rel=\"noopener\">DBEDT similarly reported in March 2026</a> that while the labor market remains firm, job growth is expected to level off as economic growth slows and population growth stays limited. The combination of genuine demand and a slowly contracting labor supply means the headline unemployment rate should not be read as evidence that broader workforce and growth challenges have been resolved.",
  ...
  "unsheltered_homeless_rate": {
    ...
    "potentialDrivers": "<a href=\"https://www.huduser.gov/portal/sites/default/files/pdf/2024-AHAR-Part-1.pdf\" target=\"_blank\" rel=\"noopener\">HUD's 2024 homeless assessment</a> attributed Hawaiʻi's rise in unsheltered homelessness to lack of affordable housing and inability to pay rent, treating that separately from the larger wildfire-driven jump in sheltered homelessness. A <a href=\"https://www.usich.gov/sites/default/files/document/Federal%20Resources%20for%20Addressing%20the%20Behavioral%20Health%20Needs%20of%20People%20Experiencing%20or%20at%20Risk%20of%20Homelessness.pdf\" target=\"_blank\" rel=\"noopener\">federal USICH/HHS guide</a> found that housing scarcity and income loss are the primary causes of homelessness, with behavioral health problems more often a barrier to exiting than an initial cause. Hawaiʻi's <a href=\"https://homelessness.hawaii.gov/wp-content/uploads/2026/01/SOHHS-HICH-Act-309-Report-to-2026-Legislature-signed.pdf\" target=\"_blank\" rel=\"noopener\">2026 legislative report on homelessness</a> added that insufficient shelter and permanent housing capacity leads to longer stays and more unsuccessful exits, and that many people fall into homelessness due to a single economic crisis rather than chronic need.",
  ...
  "road_poor_pct": {
    ...
    "potentialDrivers": "<a href=\"https://hidot.hawaii.gov/highways/files/2024/05/HDOT_TAMP_Final_May_2024.pdf\">HDOT's 2024 asset management plan</a> found that just 15 percent of the land transportation system carries about 47 percent of daily traffic, that island geography leaves most roads with few alternate routes, and that reconstruction is often cost-prohibitive because materials and labor are limited on the islands. Limited budgets mean fewer projects are planned; fuel efficiency gains have eroded gas-tax revenues over time, and in 2025 the state launched a <a href=\"https://hidot.hawaii.gov/wp-content/uploads/2025/10/FINAL-ESWRP-2025-10-15.pdf\">road usage charge program</a> to offset that revenue shortfall. <a href=\"https://climate.hawaii.gov/hi-facts/sea-level-rise/\">The state climate portal</a> notes that flooding and erosion are already damaging roads and drainage systems, adding climate-driven deterioration on top of routine wear. One measurement caveat: <a href=\"https://www.fhwa.dot.gov/policyinformation/statistics/2023/hm47.cfm\">FHWA notes</a> this metric is roughness-based (International Roughness Index) and does not capture all forms of pavement distress or local roads outside the federal reporting system.",
  ...
  "renewables_share_gen": {
    ...
    "insight": "Hawaiʻi's renewable share has risen from 5.6% in 2003 to 22.1% in 2025, driven by utility-scale solar, wind, and geothermal projects. The other-state average has also grown to 28.7%, reflecting nationwide growth in wind and solar.",
  ...
  "rainy_day_fund_pct": {
    ...
    "potentialDrivers": "For most of the 2000s and 2010s, the fund stayed near zero because Hawaiʻi lacked an automatic deposit mechanism: surpluses were typically appropriated rather than reserved, and each tourism downturn drained whatever had accumulated. <a href=\"https://budget.hawaii.gov/wp-content/uploads/2024/12/37.-Appendix-7-Debt-Affordability-Study-FB25-27-PFP.7Lt.pdf\">A 2024 debt affordability study</a> documented $500 million in transfers used in FY2023 and FY2024 to rebuild reserves and flagged pending tax cuts and potential Maui wildfire liabilities as ongoing fiscal risks; Budget and Finance also reported in 2025 that deposit conditions were not met in the most recent cycle. <a href=\"https://www.hawaiitourismauthority.org/media/14128/tourism-econ-impact-fact-sheet-january-2025.pdf\">HTA reported</a> tourism generated $2.40 billion in tax revenue in 2024, providing the general-fund base that supports reserve accumulation. One measurement note: the 14.5% dashboard reading captures only one reserve bucket; <a href=\"https://higherlogicdownload.s3.amazonaws.com/NASBO/9d2d2db1-c943-4f1b-b750-0fca152d64c2/UploadedImages/Fiscal%20Survey/NASBO_Fall_2025_Fiscal_Survey_Tables_Notes_S.pdf\">NASBO's fall 2025 survey</a> shows total balances at 33.0%, and <a href=\"https://budget.hawaii.gov/wp-content/uploads/2025/12/Budget-in-Brief-FY-27-BIB.xApH_.pdf\">Budget and Finance</a> sets policy targets of 10% in the Emergency and Budget Reserve Fund and 20 to 25% in combined reserves.",
    "useConsolidated": true,
    "hawaii": {
      "2000": 0.00181,
      "2001": 0.0063,
  ...
  "labor_productivity": {
    ...
    "whyItMatters": "Productivity shows how much the economy produces per hour, a basic sign of long-run competitiveness.",
    ...
    "potentialDrivers": "Industry mix is the primary driver: <a href=\"https://uhero.hawaii.edu/beyond-the-price-of-paradise-is-hawaii-being-left-behind/\">UHERO found</a> that Hawaiʻi's tourism, retail, and accommodation sectors are labor-intensive and produce less value per hour than sectors like technology or finance, and <a href=\"https://www.bls.gov/opub/mlr/2025/article/industry-growth-patterns-a-closer-look-at-output-productivity-and-hours-worked-from-1990-to-2024.htm\">BLS confirmed</a> accommodation and food services is the one major private sector where long-run growth is driven more by hours than by productivity gains. <a href=\"https://dbedt.hawaii.gov/economic/files/2025/06/Hawaii-General-Economic-Competitiveness-Report-2025-draft.pdf\">DBEDT placed Hawaiʻi</a> in a low-growth, low-productivity cluster of states, with R&D value added at just 0.5 percent of GDP in 2021, signaling weak investment in automation and productivity-raising technology. <a href=\"https://www.eia.gov/states/HI/analysis\">The nation's highest electricity prices</a> from petroleum dependence add further cost pressure that squeezes margins and discourages capital investment. Post-COVID tourism swings likely worsened the reading temporarily, but DBEDT's pattern holds across 2014 to 2023, pointing to structural rather than cyclical causes.",
    "useConsolidated": true,
    "hawaii": {
      "2007": 90.069,
      "2008": 89.594,
