...
const DASHBOARD_DATA = {
  ...
  "residential_price_cpkwh": {
    ...
    "rankHistoryNarrative": {
      "summary": "Hawaii has ranked #50 in residential electricity price every year on record, the only metric on this dashboard where the rank has never moved. Hawaii's isolated grids have no mainland connection and historically ran on 70 to 75 percent imported petroleum. When oil prices spiked in 2008 and again in 2022, Hawaii's residential rate spiked nearly three times harder than the national average. Renewable generation has grown from roughly 10 percent in 2012 to 40 percent by 2023, but transition capital costs are passed through to ratepayers and the price gap has widened, not closed.",
      "mode": "learn",
      "benchmarks": [
        {
          "state": "Alaska",
